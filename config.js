...
module.exports = {
    ...
    scenes: [
        {
            tts: {
                text: "Thirty four, times eleven — watch this. Split it: three, and four. Add them together: three plus four is seven. Slide that seven right between the two digits: three, seven, four. Three hundred seventy four — that's thirty four times eleven, guaranteed, every single time. One more, this one's got a twist: fifty seven. Five, and seven. Add them: five plus seven is twelve. Only the two fits in the middle, so drop the two, and add the one onto the five: five becomes six. Six, two, seven. Six hundred twenty seven. Any two digit number, times eleven — solved in your head, faster than a calculator.",
                voice: 'am_michael',
                pauseAfter: 0.6,
            },
            captions: false,
                    ...
                    data: {
                        ...
                        commands: [
                            ...
                            { id: 'clrEnd', type: 'clearAll',
                              trigger: { wordText: 'calculator', occurrence: 1 } },
                        ],
                    },
