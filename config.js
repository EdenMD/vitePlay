...
module.exports = () => ({
  output: {
    title: 'f35-brilliant-or-fragile-landscape', format: 'landscape', fps: 30, crf: 20, preset: 'medium',
  ...
  scenes: [
    ...
    // Landscape: headline top, stat-counter center, subtext bottom — all fit within 1080 height easily now.
    {
      tts: {
    ...
    // Landscape: ledger lines LEFT column, cost stamp RIGHT column.
    {
      tts: {
    ...
    // Landscape: 3 stat-counters SIDE BY SIDE instead of stacked.
    {
      tts: {
    ...
    // Landscape: ledger top, icon+redact left, stamp right.
    {
      tts: {
    ...
    // Landscape: two stat-counters LEFT/RIGHT top row, Block4 stamp center, delay stat-counter bottom.
    {
      tts: {
    ...
    // Landscape: icon LEFT, ledger + label RIGHT.
    {
      tts: {
