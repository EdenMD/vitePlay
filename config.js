...
module.exports = {
    ...
    scenes: [
        // ══ OPEN — stronger hook: the contradiction lands in line one ═════
        {
            ...
            captions: true,
            layers: [
                { type: 'stock-image', query: 'tear gas protest', source: 'serpapi', orientation: 'portrait', kenBurns: 'zoom-out', kenBurnsAmount: 0.52, x: 0, y: 0, width: 1080, height: 1920, fit: 'cover' },
        ...
        },
        {
            ...
            captions: true,
            layers: [
                { type: 'stock-image', query: 'WWI gas mask', source: 'serpapi', orientation: 'portrait', kenBurns: 'zoom-in', kenBurnsAmount: 0.56, x: 0, y: 0, width: 1080, height: 1920, fit: 'cover' },
        ...
        // ══ NEW — added emotional beat ════════════════════════════════════
        {
            ...
            captions: true,
            layers: [
                { type: 'stock-image', query: 'soldier gas mask', source: 'serpapi', orientation: 'portrait', kenBurns: 'rotate-ccw', kenBurnsAmount: 0.5, rotateDeg: 9, x: 0, y: 0, width: 1080, height: 1920, fit: 'cover' },
        ...
        // ══ THE IRONY / TURN ══════════════════════════════════════════════
        {
            ...
            captions: true,
            layers: [
                { type: 'stock-image', query: 'treaty signing', source: 'serpapi', orientation: 'portrait', kenBurns: 'pan-left', kenBurnsAmount: 0.5, x: 0, y: 0, width: 1080, height: 1920, fit: 'cover' },
                { type: 'overlay', color: 'rgba(0,0,0,0.5)' },
            ],
        },
        {
            ...
            captions: true,
            layers: [
                { type: 'stock-image', query: 'riot police', source: 'serpapi', orientation: 'portrait', kenBurns: 'rotate-cw', kenBurnsAmount: 0.55, rotateDeg: 9, x: 0, y: 0, width: 1080, height: 1920, fit: 'cover' },
                { type: 'overlay', color: 'rgba(0,0,0,0.4)' },
            ],
        },
        {
